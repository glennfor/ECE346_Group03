#!/usr/bin/env python3
"""
Final Project — safety filter entry point.

Active behavior: forwards to ``ece346.FinalProject.cbf_qp.node`` (implicit
Backup-CBF + box QP). The original student skeleton and alternate backends
(ILQR/heuristic hooks) remain below as comments for reference — do not remove.
"""

from ece346.FinalProject.cbf_qp.node import main
...
# =============================================================================
# Original file ( skeleton + ILQR/CBF mains) retained as comments.
# =============================================================================
# #!/usr/bin/env python3
# """
